...
const ScanQrCode = ({
  ...
  function checkScanResult(scanResult: QrScanResult) {
    let alertInfo = !!scanResult.data
      ? AlertMessages.qrUploadSuccess
      : AlertMessages.qrNotDetected;
    ...
    >
      ...
      <Grid item xs={12} order={1}>
        ...
        >
          ...
          >
            <img src={qr} style={{ width: "100px" }} alt="QR" />
          </div>
        </Box>
      </Grid>
      <Grid item xs={12} order={scanStatus === "Failed" ? 2 : 3}>
        <UploadQrCode
          ...
          displayMessage="Upload the QR Code"
        />
      </Grid>
      ...
      {scanStatus !== "Failed" && (
        ...
        >
          ...
          >
            Allowed file formats: PNG/JPEG/JPG Min Size : 2 x 2 cm | Max Size :
            10 x 10 cm
          </Typography>
        </Grid>
      )}
